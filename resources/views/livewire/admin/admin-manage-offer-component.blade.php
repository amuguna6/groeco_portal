                ...
                <div class="panel-body">
                    ...
                    <tbody>
                        ...
                        <td class="sorting_1">
                          1                        </td>
						<td>
                          <img src="../assets/images/OfferImage/20211027051026.png" width="200px">
                        </td>
                        <td>
                          1                        </td>
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal" data-id="10" data-name="1" data-image="20211027051026.png">
                                                    <i class="fa fa-pencil" style="color:blue; margin-right:10px;">
                                                    </i>
                                                  </a>

                          <a href="manage-offer.php?del=10" onclick="return confirm('Do you want to delete');">
                        ...
                        <td class="sorting_1">
                          2                        </td>
						<td>
                          <img src="../assets/images/OfferImage/20211027051034.png" width="200px">
                        </td>
                        <td>
                          2                        </td>
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal" data-id="11" data-name="2" data-image="20211027051034.png">
                                                    <i class="fa fa-pencil" style="color:blue; margin-right:10px;">
                                                    </i>
                                                  </a>

                          <a href="manage-offer.php?del=11" onclick="return confirm('Do you want to delete');">
                            <i class="fa fa-trash" style="color:red">
                            </i>
                          </a>
                        ...
                        <td class="sorting_1">
                          3                        </td>
						<td>
                          <img src="../assets/images/OfferImage/20211027051040.png" width="200px">
                        </td>
                        <td>
                          3                        </td>
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal" data-id="12" data-name="3" data-image="20211027051040.png">
                                                    <i class="fa fa-pencil" style="color:blue; margin-right:10px;">
                                                    </i>
                                                  </a>

                          <a href="manage-offer.php?del=12" onclick="return confirm('Do you want to delete');">
                            <i class="fa fa-trash" style="color:red">
                            </i>
                          </a>
                        ...
                        <td class="sorting_1">
                          4                        </td>
						<td>
                          <img src="../assets/images/OfferImage/20211027051051.png" width="200px">
                        </td>
                        <td>
                          4                        </td>
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal" data-id="13" data-name="4" data-image="20211027051051.png">
                                                    <i class="fa fa-pencil" style="color:blue; margin-right:10px;">
                                                    </i>
                                                  </a>

                          <a href="manage-offer.php?del=13" onclick="return confirm('Do you want to delete');">
                            <i class="fa fa-trash" style="color:red">
                            </i>
                          </a>
                        ...
                        <td class="sorting_1">
                          5                        </td>
						<td>
                          <img src="../assets/images/OfferImage/20211027051058.png" width="200px">
                        </td>
                        <td>
                          5                        </td>
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal" data-id="14" data-name="5" data-image="20211027051058.png">
                                                    <i class="fa fa-pencil" style="color:blue; margin-right:10px;">
                                                    </i>
                                                  </a>

                          <a href="manage-offer.php?del=14" onclick="return confirm('Do you want to delete');">
                            <i class="fa fa-trash" style="color:red">
                            </i>
                          </a>
                  ...
                  </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="zctb_info" role="status" aria-live="polite">Showing 1 to 5 of 5 entries</div></div><div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="zctb_paginate"><ul class="pagination"><li class="paginate_button previous disabled" id="zctb_previous"><a href="#" aria-controls="zctb" data-dt-idx="0" tabindex="0">Previous</a></li><li class="paginate_button active"><a href="#" aria-controls="zctb" data-dt-idx="1" tabindex="0">1</a></li><li class="paginate_button next disabled" id="zctb_next"><a href="#" aria-controls="zctb" data-dt-idx="2" tabindex="0">Next</a></li></ul></div></div></div></div>
                </div>
              </div>
            </div>
          </div>
